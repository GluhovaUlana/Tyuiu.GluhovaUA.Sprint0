using System;
using Tyuiu.GluhovaUA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.GluhovaUA.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Глухова У. А.| ПИНб-26-1";
            Console.WriteLine("***************************************************************************");
            ...
            if (arrayNums1.Length == arrayNums2.Length)
            {
                ...
                Console.WriteLine("Сумма элементовмассива равна:");
